...
namespace RemoteServiceExample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update RemoteServiceExampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update RemoteServiceExampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
