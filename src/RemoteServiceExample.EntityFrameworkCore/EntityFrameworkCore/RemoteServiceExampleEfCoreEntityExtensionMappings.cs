...
{
    public static class RemoteServiceExampleEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE RemoteServiceExampleModuleExtensionConfigurator CLASS (in the Domain.Shared project)
